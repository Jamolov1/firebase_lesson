...
class NonDepartmentsPage extends StatefulWidget {
  String name;
  NonDepartmentsPage({super.key, required this.name});

  @override
  State<NonDepartmentsPage> createState() => _NonDepartmentsPageState();
}

class _NonDepartmentsPageState extends State<NonDepartmentsPage> {
  List<Post> items = [];
  ...
  _apiPostList() async {
    isLoading = true;
    var list = await RTDBService.getNon();
    setState(() {
      items = list;
    });
    isLoading = false;
            ...
            return InkWell(
              onTap: () {
                Navigator.push(context, MaterialPageRoute(builder: (_) {
                  return DetailsPage(name: items[index].name ?? "",
