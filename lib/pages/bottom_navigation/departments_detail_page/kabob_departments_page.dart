...
class KabobDepartmentsPage extends StatefulWidget {
  String name;
  KabobDepartmentsPage({super.key,required this.name});

  @override
  State<KabobDepartmentsPage> createState() => _KabobDepartmentsPageState();
}

class _KabobDepartmentsPageState extends State<KabobDepartmentsPage> {
  List<Post> items = [];
