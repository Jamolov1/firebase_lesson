...
class PishiriqDepartmentsPage extends StatefulWidget {
  const PishiriqDepartmentsPage({super.key});

  @override
  State<PishiriqDepartmentsPage> createState() => _PishiriqDepartmentsPageState();
}

class _PishiriqDepartmentsPageState extends State<PishiriqDepartmentsPage> {
  List<Post> items = [];
