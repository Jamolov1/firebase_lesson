...
class ShirinlikDetailPage extends StatefulWidget {
  const ShirinlikDetailPage({super.key});

  @override
  State<ShirinlikDetailPage> createState() => _ShirinlikDetailPageState();
}

class _ShirinlikDetailPageState extends State<ShirinlikDetailPage> {
  ...
  _apiCreatePost(String name, String lastname, String about, String imgUrl) {
    ...
    RTDBService.addShirinlik(post).then((value) => {
      setState(() {
        isLoading = false;
      }),
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (_) {
        return ShirinliklarPage();
      })),
    });
  }
