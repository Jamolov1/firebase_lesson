...
import '../details/non_detail_page.dart';

class NonlarPage extends StatefulWidget {
  const NonlarPage({
    super.key,
  });

  @override
  State<NonlarPage> createState() => _NonlarPageState();
}

class _NonlarPageState extends State<NonlarPage> {
  List<Post> items = [];
  ...
  void deleteTaom(String id) {
    RTDBService.deleteNon(id).then((value) => {_apiPostList()});
  }
