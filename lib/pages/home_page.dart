...
import 'package:firebase_lesson/pages/category_page/shirinliklar_page.dart';
...
import 'package:firebase_lesson/pages/settings_page.dart';
...
import 'package:firebase_lesson/slider_add_page.dart';
import 'package:flutter/material.dart';
import 'package:internet_connection_checker_plus/internet_connection_checker_plus.dart';
import 'package:remixicon/remixicon.dart';

import 'category_page/pishiriq_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: isConnectedToInternet ? AppBar(
          leading: SizedBox(),
          title: Text(
            "Taomlar Retsepti".tr(),
            style: TextStyle(
        ...
        body:
        isConnectedToInternet ? ListView(
          children: [
            Container(
              ...
              child: Stack(
                ...
                children: [
                      ...
                      return InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            return DetailsPage(name: item.name??"",
                  ...
                  IconButton(
                      ...
                      icon: Icon(
                        Icons.add_circle, color: Colors.white, size: 30,))
                ],
              ),
            ),
          ...
          children: [
            ...
            Text("You are not connected to the internet".tr(),
